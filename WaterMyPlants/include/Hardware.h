...
namespace Hardware
{
    constexpr uint8_t SOIL_MOISTURE_SENSOR_PIN = A2;
    constexpr uint8_t LIGHT_SENSOR_PIN = A3;

    constexpr uint8_t WATER_PUMP_PIN = 8;
    constexpr uint8_t EXECUTION_BUTTON_PIN = 2;
    constexpr uint8_t MODE_CHANGER_BUTTON_PIN = 1;
    constexpr uint8_t MENU_NAVIGATION_BUTTON_PIN = 3;
